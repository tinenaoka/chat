...
if ( ! function_exists( 'woocommerce_related_products' ) ) {
	...
	function woocommerce_related_products( $args = array() ) {
		...
		$args['related_products'] = array_filter( array_map( 'wc_get_product', wc_get_related_products( $product->get_id(), 6, $product->get_upsell_ids() ) ), 'wc_products_array_filter_visible' );
